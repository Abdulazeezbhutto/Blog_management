  ...
  <div class="row g-4">
    ...
    if ($result && mysqli_num_rows($result) > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        // ✅ Fix image path with ../ prefix
        $image_path = $row['featured_image'] ? '../' . $row['featured_image'] : '../uploads/default.jpg';
        ?>
        <div class="col-lg-3 col-md-6 col-sm-12">
          <div class="card post-card h-100 shadow-sm">
            <img src="<?php echo $image_path; ?>" class="card-img-top" alt="Post Image">
            <div class="card-body">
              <h5 class="card-title text-truncate"><?php echo $row['post_title']; ?></h5>
            ...
            <div class="card-footer bg-white border-top-0 d-flex justify-content-between">
              <a href="edit_post.php?id=<?php echo $row['post_id']; ?>" class="btn btn-sm btn-warning">
                <i class="bi bi-pencil-square"></i>
              </a>
              <a href="process.php?post_id=<?= $row['post_id']; ?>&submit=delete_post" 
